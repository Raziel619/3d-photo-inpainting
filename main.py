...
parser.add_argument("--src_folder", type=str, default="image", help="Input folder")
parser.add_argument("--video_folder", type=str, default="video", help="Output videos folder")
